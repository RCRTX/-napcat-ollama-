...
AI审查会输出标准分类：诈骗广告/引流推广、违法交易、色情低俗、暴力威胁、人身攻击、隐私泄露、未成年人风险、政治敏感、赌博博彩、恶意刷屏、其他风险。二次复核会把结果标记为“确认违规”“疑似违规”“可能误报”或“二次复核不可用”。二次复核不可用时，系统会保留首次AI结果并继续正常记录和通知，只影响上报依据的标注；可能误报会保留记录但默认不发送通知。
...
- **违规告警**: 查看所有违规记录，默认按时间从新到旧排列，可按级别、违规分类、二次复核状态筛选
- **群组管理**: 查看各群消息统计和可查日期
